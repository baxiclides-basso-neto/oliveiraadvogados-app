import { StyledCards } from "@/styles/CardsMainStyle";
  ...
  return (
    <StyledCards>
      ...
      <div className="card-list">
        <div className="card">
          <Image src="/saudeImg.jpg" alt="saude no trabalho" width={250} height={250} />
          <h3>
        ...
        <div className="card">
          <Image src="/remuneracaoImg.jpg" alt="Remuneracao no trabalho" width={250} height={250} />
        ...
        <div className="card">
          <Image src="/salarioFamiliaImg.jpg" alt="Salario Família" width={250} height={250} />
        ...
        <div className="card">
          <Image src="/estabilidadeImg.webp" alt="Estabilidade no emprego" width={250} height={250} />
        ...
        <div className="card">
          <Image src="/feriasImg.jpg" alt="Direito de férias" width={250} height={250} />
          <h3>
